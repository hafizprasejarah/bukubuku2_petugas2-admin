import 'package:bukubuku2_petugas2/app/data/model/response_book.dart';
...
//       await Future.delayed(Duration(milliseconds: 100));
      ...
      if (response.statusCode == 200) {
        ...
        if (responseBook.data != null) {
          ...
          Get.snackbar('Error', 'Data buku kosong untuk kategori yang dipilih',
              backgroundColor: Colors.red);
        }
      } else {
        Get.snackbar(
            'Error', 'Gagal mengambil data: ${response.data['message']}',
            backgroundColor: Colors.red);
      }
      ...
      if (e.response != null && e.response?.data != null) {
        ...
        Get.snackbar('Error', 'Kesalahan terjadi: ${e.message ?? ""}',
            backgroundColor: Colors.red);
      }
    } catch (e) {
      Get.snackbar('Error', 'Kesalahan terjadi: $e',
